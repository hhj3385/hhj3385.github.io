...
(function () {
  ...
  const PROJECTS = [
    ...
    { id: "bid", kind: "biz", title: "공공사업 제안 컨설팅 — 13건 참여, 7건 수주", when: "2025.02 – 2026.05", meta: "컨설팅팀", thumb: "bid",
      problem: "공공 데이터·플랫폼 사업은 제안 요청서 분석부터 아키텍처, 데이터 설계, 발표까지 짧은 기간에 설득력 있는 제안서를 만들어야 합니다.",
      did: "컨설팅팀에서 1년 3개월간 공공사업 제안 13건에 참여했습니다. 제안서 작성과 시스템 아키텍처·데이터 설계 파트, 발표 자료를 맡았고, 제안서·발표자료를 재활용할 수 있게 슬라이드 단위로 정리한 경험이 사내 지식 저장소 플랫폼 개발로 이어졌습니다.",
      result: "13건 중 7건 수주. 국내 대형 공항 데이터플랫폼 구축 사업도 이 기간의 제안이 수주로 이어진 사례입니다.",
      metrics: [["제안 참여", "13건"], ["수주", "7건"], ["수주율", "54%"]],
      tags: ["제안서 작성", "시스템 아키텍처", "데이터 설계", "발표"] },
  ...
  const THUMBS = {
    ...
    bid: `<svg viewBox="0 0 160 100"><rect class="g-box" x="22" y="26" width="44" height="56" rx="4"/><rect class="g-box" x="30" y="18" width="44" height="56" rx="4"/><rect class="g-fill" x="38" y="10" width="44" height="56" rx="4"/><path class="g-line" d="M46 24h28M46 34h28M46 44h18"/><path class="g-line" d="M90 40h14"/><rect class="g-box" x="104" y="16" width="44" height="14" rx="3"/><rect class="g-box" x="104" y="36" width="44" height="14" rx="3"/><rect class="g-box" x="104" y="56" width="44" height="14" rx="3"/><path class="g-line" d="M110 23l3 3 6-6M110 43l3 3 6-6"/><circle class="g-dot" cx="113" cy="63" r="2"/><text class="g-txt" x="80" y="92" text-anchor="middle">13 제안 → 7 수주</text></svg>`,
